...
#
#PBS -N CNN-SATD-columba-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-columba-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-columba-all-comments train-columba.txt test-columba.txt config-all-comments.yml
