...
#
#PBS -N CNN-SATD-columba-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-columba-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-columba-no-comments train-columba.txt test-columba.txt config-no-comments.yml
