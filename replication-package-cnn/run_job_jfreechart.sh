...
#
#PBS -N CNN-SATD-jfreechart
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jfreechart.out
#
...
bash ./train-all.sh 10 171025193635-10-Folds runs-jfreechart-GOOD train-jfreechart.txt test-jfreechart.txt
