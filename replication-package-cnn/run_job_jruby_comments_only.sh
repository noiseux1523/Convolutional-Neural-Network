...
#
#PBS -N CNN-SATD-jruby-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jruby-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-jruby-comments-only train-jruby.txt test-jruby.txt config-comments-only.yml
