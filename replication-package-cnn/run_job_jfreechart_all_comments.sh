...
#
#PBS -N CNN-SATD-jfreechart-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jfreechart-all-comments.out
#
...
cd $SCRATCH/cnn-text-classification
 
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-jfreechart-all-comments train-jfreechart.txt test-jfreechart.txt config-all-comments.yml
