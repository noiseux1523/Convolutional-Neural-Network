...
#
#PBS -N CNN-SATD-argo-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-argo-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-argo-no-comments train-argo.txt test-argo.txt config-no-comments.yml
