...
#
#PBS -N CNN-SATD-hibernate-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-hibernate-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-hibernate-no-comments train-hibernate.txt test-hibernate.txt config-no-comments.yml
