...
#
#PBS -N CNN-SATD-argo-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-argo-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-argo-all-comments train-argo.txt test-argo.txt config-all-comments.yml
