...
#
#PBS -N CNN-SATD-jfreechart-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jfreechart-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-jfreechart-comments-only train-jfreechart.txt test-jfreechart.txt config-comments-only.yml
