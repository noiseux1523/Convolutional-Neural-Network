...
#
#PBS -N CNN-SATD-sql12-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-sql12-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-sql12-no-comments train-sql12.txt test-sql12.txt config-no-comments.yml
