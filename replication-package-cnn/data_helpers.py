...
def batch_iter(data, batch_size, num_epochs, shuffle=True):
    ...
    print("num_epochs: {}, data_size: {}, batch_size: {}, num_batches_per_epoch: {}".format(num_epochs, data_size, batch_size, num_batches_per_epoch))
        ...
        if binary:
            ...
            for line_no in range(vocab_size):
                ...
                while True:
                    ...
                    if ch != b'\n':
                        word.append(ch)
                word = str(b''.join(word)).encode(encoding=encoding, errors='strict')
            ...
            for line_no in range(vocab_size):
                ...
                if line == b'':
                    raise EOFError("unexpected end of input; is count incorrect or file otherwise damaged?")
                parts = str(line.rstrip()).encode(encoding=encoding, errors='strict').split(" ")
