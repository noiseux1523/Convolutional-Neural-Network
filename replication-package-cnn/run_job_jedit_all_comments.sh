...
#
#PBS -N CNN-SATD-jedit-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jedit-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-jedit-all-comments train-jedit.txt test-jedit.txt config-all-comments.yml
