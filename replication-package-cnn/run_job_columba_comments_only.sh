...
#
#PBS -N CNN-SATD-columba-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-columba-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-columba-comments-only train-columba.txt test-columba.txt config-comments-only.yml
