...
#
#PBS -N CNN-SATD-argo-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-argo-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-argo-comments-only train-argo.txt test-argo.txt config-comments-only.yml
