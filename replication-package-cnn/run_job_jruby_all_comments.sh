...
#
#PBS -N CNN-SATD-jruby-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jruby-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-jruby-all-comments train-jruby.txt test-jruby.txt config-all-comments.yml
