...
#
#PBS -N CNN-SATD-ant-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-ant-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-ant-all-comments train-ant.txt test-ant.txt config-all-comments.yml
