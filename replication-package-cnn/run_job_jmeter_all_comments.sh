...
#
#PBS -N CNN-SATD-jmeter-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jmeter-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-jmeter-all-comments train-jmeter.txt test-jmeter.txt config-all-comments.yml
