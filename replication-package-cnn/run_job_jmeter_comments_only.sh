...
#
#PBS -N CNN-SATD-jmeter-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jmeter-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-jmeter-comments-only train-jmeter.txt test-jmeter.txt config-comments-only.yml
