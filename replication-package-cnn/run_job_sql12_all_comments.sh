...
#
#PBS -N CNN-SATD-sql12-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-sql12-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-sql12-all-comments train-sql12.txt test-sql12.txt config-all-comments.yml
