...
#
#PBS -N CNN-SATD-ant-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-ant-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-ant-comments-only train-ant.txt test-ant.txt config-comments-only.yml
