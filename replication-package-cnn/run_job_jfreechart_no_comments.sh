...
#
#PBS -N CNN-SATD-jfreechart-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jfreechart-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-jfreechart-no-comments train-jfreechart.txt test-jfreechart.txt config-no-comments.yml
