...
#
#PBS -N CNN-SATD-jedit-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jedit-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-jedit-no-comments train-jedit.txt test-jedit.txt config-no-comments.yml
