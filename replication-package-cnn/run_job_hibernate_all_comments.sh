...
#
#PBS -N CNN-SATD-hibernate-all-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-hibernate-all-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010155551-10-Folds runs-hibernate-all-comments train-hibernate.txt test-hibernate.txt config-all-comments.yml
