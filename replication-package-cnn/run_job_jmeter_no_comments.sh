...
#
#PBS -N CNN-SATD-jmeter-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jmeter-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-jmeter-no-comments train-jmeter.txt test-jmeter.txt config-no-comments.yml
