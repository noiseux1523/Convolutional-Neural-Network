...
#
#PBS -N CNN-SATD-jruby-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jruby-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-jruby-no-comments train-jruby.txt test-jruby.txt config-no-comments.yml
