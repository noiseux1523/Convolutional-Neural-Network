...
#
#PBS -N CNN-SATD-sql12-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-sql12-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-sql12-comments-only train-sql12.txt test-sql12.txt config-comments-only.yml
