...
#
#PBS -N CNN-SATD-hibernate-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-hibernate-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-hibernate-comments-only train-hibernate.txt test-hibernate.txt config-comments-only.yml
