...
cat ./data/$FolderName/$TrainName | while read train; 
	...
	./train.py --enable_word_embeddings true --num_epochs 6 --dev_sample_percentage 0.01 --num_filters 128 --batch_size 32 --where $RunsName --positive_train=$pos --negative_train=$neg
