...
#
#PBS -N CNN-SATD-ant-no-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-ant-no-comments.out
#
...
bash ./train-all-all-comments.sh 10 171010145001-10-Folds runs-ant-no-comments train-ant.txt test-ant.txt config-no-comments.yml
