...
#
#PBS -N CNN-SATD-jedit-comments
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-jedit-comments.out
#
...
bash ./train-all-all-comments.sh 10 171026120402-10-Folds runs-jedit-comments-only train-jedit.txt test-jedit.txt config-comments-only.yml
