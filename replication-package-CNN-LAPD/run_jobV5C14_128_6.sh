...
#
#PBS -N CNN-LAPD-V5C14-128-6
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V5C14-128-6.out
#
...
bash train-all-V5C14.sh data/OracleV5C14-training/train.txt OracleV5C14-128-6 128 6

bash eval-all-V5C14.sh data/OracleV5C14-training/test.txt OracleV5C14-128-6
