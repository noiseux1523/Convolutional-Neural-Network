...
#
#PBS -N CNN-LAPD-C5-HP
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C5-HP.out
#
...
#bash train-allC5-HP.sh data/OracleC5-traininG/train.txt OracleC5-HP

bash eval-allC5-HP.sh data/OracleC5-training/test.txt OracleC5-HP
