...
#
#PBS -N CNN-LAPD-V3C2-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C2-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C2-training/train.txt OracleV3C2-training

bash eval-all-training.sh data/OracleV3C2-training/test.txt OracleV3C2-training
