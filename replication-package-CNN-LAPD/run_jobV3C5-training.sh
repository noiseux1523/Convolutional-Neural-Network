...
#
#PBS -N CNN-LAPD-V3C5-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C5-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C5-training/train.txt OracleV3C5-training

bash eval-all-training.sh data/OracleV3C5-training/test.txt OracleV3C5-training
