...
#
#PBS -N CNN-LAPD-C8-training-HP-200
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C8-training-HP-200.out
#
...
virtualenv $SCRATCH/CNN-LAPD/tensorflow

# activate my virtualenv

source $SCRATCH/CNN-LAPD/tensorflow/bin/activate
...
#bash train-allC8-training-HP-100.sh data/OracleC8-training/train.txt OracleC8-training-HP-100

bash eval-allC8-training-HP-200.sh data/OracleC8-training/test.txt OracleC8-training-HP-200
