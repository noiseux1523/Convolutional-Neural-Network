...
#
#PBS -N CNN-LAPD-V5C14-128-5-5-5
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V5C14-128-5-5-5.out
#
...
bash train-all-V5C14.sh data/OracleV5C14-training/train.txt OracleV5C14-128-5-5-5 128 "5,5,5"

bash eval-all-V5C14.sh data/OracleV5C14-training/test.txt OracleV5C14-128-5-5-5
