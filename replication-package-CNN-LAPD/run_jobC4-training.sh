...
#
#PBS -N CNN-LAPD-C4-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C4-training.out
#
...
#bash train-allC4-training.sh data/OracleC4-training/train.txt OracleC4-training

bash eval-allC4-training.sh data/OracleC4-training/test.txt OracleC4-training
