...
## added to store in different places


tf.flags.DEFINE_string("where", "runs", "where data will be stored") # giulio added ...
...
tf.flags.DEFINE_string("ymlconfig", "config.yml" , "YML config file")
...
with open(FLAGS.ymlconfig, 'r') as ymlfile:
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir   = os.path.abspath(os.path.join(os.path.curdir, FLAGS.where, timestamp)) # giulio force write in different directories ,,,
        print("Writing to {}\n".format(out_dir))
