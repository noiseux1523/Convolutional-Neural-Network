...
#
#PBS -N CNN-LAPD-C8-training-HP-100
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C8-training-HP-100.out
#
...
bash eval-allC8-training-HP-100.sh data/OracleC8-training/test.txt OracleC8-training-HP-100
