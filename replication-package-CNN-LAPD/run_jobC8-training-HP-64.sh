...
#
#PBS -N CNN-LAPD-C8-training-HP-64
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C8-training-HP-64.out
#
...
#bash train-allC8-training-HP-64.sh data/OracleC8-training/train.txt OracleC8-training-HP-64

bash eval-allC8-training-HP-64.sh data/OracleC8-training/test.txt OracleC8-training-HP-64
