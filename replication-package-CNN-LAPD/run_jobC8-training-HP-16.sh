...
#
#PBS -N CNN-LAPD-C8-training-HP-16
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C8-training-HP-16.out
#
...
#bash train-allC8-training-HP-16.sh data/OracleC8-training/train.txt OracleC8-training-HP-16

bash eval-allC8-training-HP-16.sh data/OracleC8-training/test.txt OracleC8-training-HP-16
