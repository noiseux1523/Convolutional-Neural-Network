...
# Data loading params
tf.flags.DEFINE_string("where", "runs", "where data will be stored")
...
with open("configC8-training.yml", 'r') as ymlfile:
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir   = os.path.abspath(os.path.join(os.path.curdir, FLAGS.where, timestamp)) ## added here the directory to simplify reading 
        print("Writing to {}\n".format(out_dir))
