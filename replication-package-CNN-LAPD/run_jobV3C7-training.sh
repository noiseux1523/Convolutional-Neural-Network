...
#
#PBS -N CNN-LAPD-V3C7-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C7-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C7-training/train.txt OracleV3C7-training

bash eval-all-training.sh data/OracleV3C7-training/test-complete.txt OracleV3C7-training
