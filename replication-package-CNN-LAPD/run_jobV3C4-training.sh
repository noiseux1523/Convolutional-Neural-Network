...
#
#PBS -N CNN-LAPD-V3C4-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C4-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C4-training/train.txt OracleV3C4-training

bash eval-all-training.sh data/OracleV3C4-training/test.txt OracleV3C4-training
