...
#
#PBS -N CNN-LAPD-C5-HP-100
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C5-HP-100.out
#
...
#bash train-allC5-HP-100.sh data/OracleC5-training/train.txt OracleC5-HP-100

bash eval-allC5-HP-100.sh data/OracleC5-training/test.txt OracleC5-HP-100
