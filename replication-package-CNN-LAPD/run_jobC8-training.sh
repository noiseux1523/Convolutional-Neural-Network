...
#bash train-allC8-training.sh data/OracleC8-training/train.txt OracleC8-training

bash eval-allC8-training.sh data/OracleC8-training/test.txt OracleC8-training
