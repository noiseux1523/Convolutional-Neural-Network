...
#
#PBS -N CNN-LAPD-C2-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C2-training.out
#
...
#bash train-allC2-training.sh data/OracleC2-training/train.txt OracleC2-training

bash eval-allC2-training.sh data/OracleC2-training/test.txt OracleC2-training
