...
#
#PBS -N CNN-LAPD-C3-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C3-training.out
#
...
#bash train-allC3-training.sh data/OracleC3-training/train.txt OracleC3-training

bash eval-allC3-training.sh data/OracleC3-training/test.txt OracleC3-training
