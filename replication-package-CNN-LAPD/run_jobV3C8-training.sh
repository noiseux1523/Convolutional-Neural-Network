...
#
#PBS -N CNN-LAPD-V3C8-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C8-TRAINING.out
#
...
bash train-all-training.sh data/OracleV3C8-training/train.txt OracleV3C8-training

bash eval-all-training.sh data/OracleV3C8-training/test.txt OracleV3C8-training
