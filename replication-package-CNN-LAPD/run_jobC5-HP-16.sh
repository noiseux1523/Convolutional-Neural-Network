...
#
#PBS -N CNN-LAPD-C5-HP-16
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C5-HP-16.out
#
...
#bash train-allC5-HP-16.sh data/OracleC5-training/train.txt OracleC5-HP-16

bash eval-allC5-HP-16.sh data/OracleC5-training/test.txt OracleC5-HP-16
