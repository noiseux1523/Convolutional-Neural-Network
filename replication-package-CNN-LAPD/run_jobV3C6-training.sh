...
#
#PBS -N CNN-LAPD-V3C6-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C6-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C6-training/train.txt OracleV3C6-training

bash eval-all-training.sh data/OracleV3C6-training/test-complete.txt OracleV3C6-training
