...
#
#PBS -N CNN-LAPD-C5-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C5-training.out
#
...
#bash train-allC5-training.sh data/OracleC5-training/train.txt OracleC5-training

bash eval-allC5-training.sh data/OracleC5-training/test.txt OracleC5-training
