...
#
#PBS -N CNN-LAPD-C7-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C7-training.out
#
...
#bash train-allC7-training.sh data/OracleC7-training/train.txt OracleC7-training

bash eval-allC7-training.sh data/OracleC7-training/test.txt OracleC7-training
