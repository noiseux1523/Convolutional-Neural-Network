...
#
#PBS -N CNN-LAPD-C8-training-HP
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C8-training.out
#
...
#bash train-allC8-training-HP.sh data/OracleC8-training/train.txt OracleC8-training-HP

bash eval-allC8-training-HP.sh data/OracleC8-training/test.txt OracleC8-training-HP
