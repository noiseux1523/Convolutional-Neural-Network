...
#
#PBS -N CNN-LAPD-V3C3-TRAINING
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-V3C3-TRAINING.out
#
...
#bash train-all-training.sh data/OracleV3C3-training/train.txt OracleV3C3-training

bash eval-all-training.sh data/OracleV3C3-training/test.txt OracleV3C3-training
