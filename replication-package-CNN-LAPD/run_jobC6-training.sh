...
#
#PBS -N CNN-LAPD-C6-training
 
# --------------------------------------------------------------
#
# Standard output file (stdout)
#
#PBS -o ./output-C6-training.out
#
...
#bash train-allC6-training.sh data/OracleC6-training/train.txt OracleC6-training

bash eval-allC6-training.sh data/OracleC6-training/test.txt OracleC6-training
